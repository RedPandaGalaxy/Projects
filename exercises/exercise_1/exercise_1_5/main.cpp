...
const char *vertexShaderSource = "#version 330 core\n"
                                 ...
                                 "void main()\n"
                                 "{\n"
                                 "   gl_Position = vec4(aPos.x-0.25, aPos.y-0.25, aPos.z, 1.0);\n"
                                 "   vtxColor = aColor;\n"
                                 "}\0";
...
void setupRotation(float rotSpeed, std::vector<float>& vertices) {
    float radius = 0.5f;
    float alpha = 2 * PI / rotSpeed; //alpha of each circle

    float angle = rotSpeed * PI / 180;
